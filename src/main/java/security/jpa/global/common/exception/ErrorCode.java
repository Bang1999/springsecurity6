...
public enum ErrorCode {
    ...
    REGISTER_FAIL(40005, HttpStatus.BAD_REQUEST, "회원 가입 실패!"),
    VALIDATION_FAIL(40006, HttpStatus.BAD_REQUEST, "유효성 검사 실패"),
    BAD_REQUEST_IMAGE(40007, HttpStatus.BAD_REQUEST, "잘못된 JSON 형식입니다."),
    ...
    MEMBER_NOT_FOUND(40401, HttpStatus.BAD_REQUEST, "해당 멤버을 찾을 수 없습니다."),
    NOT_FOUND_JWT_TOKEN(40402, HttpStatus.NOT_FOUND, "JWT 토큰이 없습니다."),
